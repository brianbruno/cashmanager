        ...
        <nav>
            <div class="nav-wrapper blue-grey lighten-5" id="cripto-values">
                ...
                <div class="chip" v-bind:style="coins_bgc">
                    ...
                    <span class="blue-grey-text">BTC {{ market[5].price_btc }} </span> <span class="red-text" v-bind:class="{ 'red-text': litecoin_perda, 'green-text': litecoin_lucro }">{{ market[5].percent_change_24h }}%</span>
                </div>
                <div class="chip" v-bind:style="coins_bgc">
                    <img src="http://cashmanager.brian.place/public/img/eth.png" alt="eth">
                    <span class="blue-grey-text">BTC {{ market[1].price_btc }} </span> <span class="red-text" v-bind:class="{ 'red-text': eth_perda, 'green-text': eth_lucro }">{{ market[1].percent_change_24h }}%</span>
                </div>
                <div class="chip" v-bind:style="coins_bgc">
                    <img src="http://cashmanager.brian.place/public/img/dash.png" alt="dash">
                    <span class="blue-grey-text">BTC {{ market[11].price_btc }} </span><span class="red-text" v-bind:class="{ 'red-text': dash_perda, 'green-text': dash_lucro }">{{ market[11].percent_change_24h }}%</span>
                </div>
            </div>
        </nav>
    </div>
